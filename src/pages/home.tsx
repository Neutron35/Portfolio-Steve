...
function Home() {
  ...
  const animationClasses = (baseClass: string) => `${baseClass} ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`;
  ...
  return (
    <section className="w-full pt-9 md:pt-16">
      ...
      >
        <h1 className={`transition-opacity delay-[400ms] duration-700 ${animationClasses('')}`}>
          Steve LIEURON
        </h1>
