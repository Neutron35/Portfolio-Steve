import imgSteveTablet from '@/Portfolio/assets/portrait-steve-360.webp';
import imgSteveMobile from '@/Portfolio/assets/portrait-steve-240.webp';
import useIntersectionObserver from '@/hooks/useIntersectionObserver.tsx'; // Hook personnalisé pour observer l'intersection
import LinkArrow from '@/Portfolio/components/linkarrow.tsx';
import getTailwindBreakpoints from '@/Portfolio/lib/tailwindBreakpoints.ts';
