import Timeline from '@/Portfolio/components/timeline.tsx';
import Skills from '@/Portfolio/components/skills.tsx';
import { ExperienceContent, SectionType, SkillsContent } from '@/Portfolio/types/section.types.ts';
...
function AboutSection({ section }: { section: SectionType }) {
  ...
  return (
    <section
      className="mt-20 flex w-full flex-col items-center gap-9 rounded-[100px] border-t border-[#1B1B1B] px-4 pt-8 md:mt-24 md:px-8">
